...
let h1Yeni = document.querySelector("h1");
h1Yeni.textContent = siteContent.cta["h1"];

let buttonYeni = document.querySelector("button");
buttonYeni.textContent = siteContent.cta["button"];

let ctaImg = document.querySelector(".cta img");
ctaImg.setAttribute("src", "http://localhost:9000/img/cta.png");

let icerik = document.querySelector(".top-content h4", ".top-content p");
let icerikKeys = Object.keys(siteContent["ana-içerik"]);
